...
HD_PWD='E:/FACULTATE/AN 3/SEMESTRUL 1/SSC/PROIECT/PROIECT_SSC/PROIECT_SSC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mouse_to_vga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mouse_to_vga.tcl -notrace
