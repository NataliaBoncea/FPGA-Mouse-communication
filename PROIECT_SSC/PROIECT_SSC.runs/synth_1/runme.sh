...
HD_PWD='E:/FACULTATE/AN 3/SEMESTRUL 1/SSC/PROIECT/PROIECT_SSC/PROIECT_SSC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mouse_to_vga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mouse_to_vga.tcl
